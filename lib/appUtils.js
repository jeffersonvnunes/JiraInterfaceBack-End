       ...
       if(data.issues) {
           ...
           for (let i = 0; i < data.issues.length; i++) {
               ...
               if(data.issues[i].renderedFields){
                   ...
                   issues[i].storyPoints = data.issues[i].renderedFields.customfield_10014;
               ...
               if(data.issues[i].fields.priority){
                   issues[i].priority.id = data.issues[i].fields.priority.id;
                   issues[i].priority.name = data.issues[i].fields.priority.name;
               }
